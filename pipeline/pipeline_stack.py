                                  ...
                                  codepipeline.StageProps(stage_name="Test",
                                                          actions=[
                                                              ...
                                                              codepipeline_actions.CloudFormationCreateUpdateStackAction(
                                                                  ...
                                                                  parameter_overrides={
                                                                      "ImageId": "#{BuildVariables.AMIID}", "TestEnv": "#{BuildVariables.TestEnv}"},
                                                                  admin_permissions=True,
                                                                  extra_inputs=[
                                                                      custom_ami_build_output, batch_build_output]
                                                              )]
                                                          ),
                                  codepipeline.StageProps(stage_name="FinalStack",
                                                          actions=[
                                                              ...
                                                              codepipeline_actions.CloudFormationCreateUpdateStackAction(
                                                                  ...
                                                                  parameter_overrides={
                                                                      "ImageId": "#{BuildVariables.AMIID}", "MainEnv": "#{BuildVariables.MainEnv}"},
                                                                  admin_permissions=True,
                                                                  extra_inputs=[
                                                                      custom_ami_build_output, batch_build_output]
                                                              )]
